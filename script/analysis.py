...
def seasonality_decomposition(input_df, output_path, period_num):
    ...
    for column in temp_df.columns:
        ...
        result = seasonal_decompose(plot_df, model='multiplicative', period=period_num)  # Adjust period as needed
        ...
        # Adjust layout
        plt.tight_layout()
        plt.savefig(output_path + "resample_" + str(period_num) + "_" + column + ".png", dpi=600)
